                        ...
                        ABLSynCallback.call(new ABLSynCallback.BackgroundCall() {
                            ...
                            public void callback(Object obj) {
                                if (((Boolean) obj).booleanValue()) {
                                    ...
                                    new HintDialog(SelectKcCcActivity.this, R.style.dialog, "提取考生完成，共有" + DbServices.getInstance(getBaseContext()).queryBKKSList(kc.getKc_name(), cc.getCc_name()) + "个考生", new HintDialog.OnCloseListener() {
                                        @Override
                                        public void onClick(Dialog dialog, boolean confirm) {
                                            if (confirm) {
                                                dialog.dismiss();
